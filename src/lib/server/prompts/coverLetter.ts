...
5. Write 3-5 paragraphs. Vivid, dramatic, editorial-noir in register (stage, ledger, record, gallery — not gaudy steampunk mechanics).
6. This should be unlike any character reference the reader has ever seen — memorable, specific, dripping with theatrical authority.
7. Open with a dramatic salutation (not "To Whom It May Concern" — something theatrical).
8. Close with a flourish and sign as "The Architect, Presiding Magistrate of the Court of Suspicion."
...
Write a single dramatic closing line (1-2 sentences) as The Architect, commenting on the verdict. This is your final word — make it memorable. Editorial-noir register: stage, record, gallery — restrained, not gaudy.
